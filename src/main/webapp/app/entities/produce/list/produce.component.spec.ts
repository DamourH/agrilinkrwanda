...
import { sampleWithRequiredData } from '../produce.test-samples';
...
describe('Produce Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProduceComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.produces()[0]).toEqual(expect.objectContaining({ id: 792 }));
  });

  describe('trackId', () => {
    it('should forward to produceService', () => {
      const entity = { id: 792 };
      jest.spyOn(service, 'getProduceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProduceIdentifier).toHaveBeenCalledWith(entity);
