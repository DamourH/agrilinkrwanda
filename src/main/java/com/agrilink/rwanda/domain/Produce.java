...
@Entity
@Table(name = "produce")
@org.springframework.data.elasticsearch.annotations.Document(indexName = "produce")
...
public class Produce implements Serializable {
    ...
    public Produce category(ProductCategory productCategory) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((Produce) o).getId());
    }
