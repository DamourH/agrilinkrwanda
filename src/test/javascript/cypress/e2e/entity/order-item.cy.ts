...
describe('OrderItem e2e test', () => {
  ...
  const orderItemSample = { quantity: 743.99, priceAtOrder: 27506.88 };
  ...
  describe('new OrderItem page', () => {
    ...
    it('should create an instance of OrderItem', () => {
      cy.get(`[data-cy="quantity"]`).type('28881.21');
      cy.get(`[data-cy="quantity"]`).should('have.value', '28881.21');

      cy.get(`[data-cy="priceAtOrder"]`).type('22009.5');
      cy.get(`[data-cy="priceAtOrder"]`).should('have.value', '22009.5');
