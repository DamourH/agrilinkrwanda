...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'ah annex' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('toward');
      cy.get(`[data-cy="name"]`).should('have.value', 'toward');

      cy.get(`[data-cy="description"]`).type('ostrich cone');
      cy.get(`[data-cy="description"]`).should('have.value', 'ostrich cone');
