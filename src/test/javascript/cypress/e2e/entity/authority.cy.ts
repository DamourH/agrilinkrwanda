...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '08a42bea-eea8-43a0-bd77-089af8149801' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('68f86b88-3144-41d9-ba9b-4be07d17be3f');
      cy.get(`[data-cy="name"]`).should('have.value', '68f86b88-3144-41d9-ba9b-4be07d17be3f');
