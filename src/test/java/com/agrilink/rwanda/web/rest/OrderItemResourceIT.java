...
import static com.agrilink.rwanda.domain.OrderItemAsserts.*;
...
class OrderItemResourceIT {
    ...
    private static final BigDecimal DEFAULT_PRICE_AT_ORDER = new BigDecimal(1);
    private static final BigDecimal UPDATED_PRICE_AT_ORDER = new BigDecimal(2);
    ...
    public static OrderItem createEntity() {
        return new OrderItem().quantity(DEFAULT_QUANTITY).priceAtOrder(DEFAULT_PRICE_AT_ORDER);
    }
    ...
    public static OrderItem createUpdatedEntity() {
        return new OrderItem().quantity(UPDATED_QUANTITY).priceAtOrder(UPDATED_PRICE_AT_ORDER);
    }
    ...
    @Test
    @Transactional
    void checkPriceAtOrderIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(orderItemSearchRepository.findAll());
        // set the field null
        orderItem.setPriceAtOrder(null);
    ...
    void getAllOrderItems() throws Exception {
        ...
        restOrderItemMockMvc
            ...
            .andExpect(jsonPath("$.[*].priceAtOrder").value(hasItem(sameNumber(DEFAULT_PRICE_AT_ORDER))));
    }
    ...
    void getOrderItem() throws Exception {
        ...
        restOrderItemMockMvc
            ...
            .andExpect(jsonPath("$.priceAtOrder").value(sameNumber(DEFAULT_PRICE_AT_ORDER)));
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        updatedOrderItem.quantity(UPDATED_QUANTITY).priceAtOrder(UPDATED_PRICE_AT_ORDER);
    ...
    void fullUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.quantity(UPDATED_QUANTITY).priceAtOrder(UPDATED_PRICE_AT_ORDER);
