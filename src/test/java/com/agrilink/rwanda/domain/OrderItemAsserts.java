...
public class OrderItemAsserts {
    ...
    public static void assertOrderItemUpdatableFieldsEquals(OrderItem expected, OrderItem actual) {
        assertThat(actual)
            ...
            .satisfies(a ->
                assertThat(a.getPriceAtOrder())
                    .as("check priceAtOrder")
                    .usingComparator(bigDecimalCompareTo)
                    .isEqualTo(expected.getPriceAtOrder())
            );
    }
    ...
    public static void assertOrderItemUpdatableRelationshipsEquals(OrderItem expected, OrderItem actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getFarmerProduce()).as("check farmerProduce").isEqualTo(expected.getFarmerProduce()));
    }
}
